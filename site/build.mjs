...
const REPO = 'https://github.com/Allan-Nava/transcriptmeter'
const BLOB = `${REPO}/blob/main`
const SITE = 'https://allan-nava.github.io/transcriptmeter/'
...
<meta name="theme-color" content="#7a4b8c" media="(prefers-color-scheme: light)">
...
:root {
  ...
  --accent: #7a4b8c; --accent-soft: #f1e9f5; --code-bg: #f4f1ec;
...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --accent: #c9a3dc; --accent-soft: #211826; --code-bg: #1c1a17;
  }
}
...
<footer>
  <div class="wrap row">
    <span>MIT · <a href="${REPO}">Allan-Nava/transcriptmeter</a></span>
...
// what gets transcriptmeter listed there; a robots.txt at /transcriptmeter/ would be dead weight.
